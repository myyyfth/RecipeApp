    ...
    val listBreakfast: ArrayList<Recipes>
                    ...
                    for (data in proteinBreakfast.indices) {
                        val recipe = Recipes(
                            ...
                            ingridients = ingredientsBreakfast[data],
        ...
        get() {
            ...
            for (data in proteinDessert.indices) {
                val recipe = Recipes(
                    ...
                    category = caloriesDessert[data],
                    description = descriptionDessert[data],
                    ingridients = ingredientsDessert[data],
        ...
        get() {
            ...
            for (data in proteinVegetarian.indices) {
                val recipe = Recipes(
                    ...
                    category = caloriesVegetarian[data],
                    description = descriptionVegetarian[data],
                    ingridients = ingredientsVegetarian[data],
